...
import {
  ...
  PieChart, UserCog, LogOut, HardDrive, Flame, ClipboardList, Lightbulb, Network, Briefcase,
} from 'lucide-react'
...
const menuItems = [
  ...
  { href: '/contacts', label: '人脈リスト', icon: Network },
  ...
  { href: '/director', label: 'ディレクター管理表', icon: Briefcase },
]
...
export default function Sidebar() {
  ...
  useEffect(() => {
    ...
    fetch('/api/tasks?mode=assigned_to_me', { signal: controller.signal })
      .then((r) => r.json())
      .then((data) => {
        clearTimeout(timer)
