  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl shadow-2xl p-10 w-full max-w-sm text-center">
        ...
        <p className="text-sm text-white/50 mb-8">Googleアカウントでサインイン</p>

        <button
          onClick={() => signIn('google', { callbackUrl })}
          className="w-full flex items-center justify-center gap-3 px-5 py-3 bg-white rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 transition-all shadow-lg"
        >
        ...
        <p className="text-xs text-white/25 mt-6">
          サインインすることでGoogleカレンダー・Drive<br />との連携が有効になります
        </p>
      </div>
    </div>
  )
